...
import com.richikin.jetman.characters.misc.DefenceStation;
import com.richikin.jetman.characters.enemies.Missile;
import com.richikin.jetman.characters.misc.MissileBase;
import com.richikin.jetman.characters.enemies.DefenderBullet;
...
public class MissileBaseManager extends GenericEntityManager
{
    ...
    {
        SpriteDescriptor descriptor = App.entities.getDescriptor(GraphicID.G_MISSILE);
        descriptor._SIZE       = GameAssets.getAssetSize(GraphicID.G_MISSILE);
        descriptor._POSITION.x = startX;
        descriptor._POSITION.y = startY;
        descriptor._POSITION.z = App.entityUtils.getInitialZPosition(GraphicID.G_MISSILE);
        descriptor._INDEX      = App.entityData.entityMap.size;
